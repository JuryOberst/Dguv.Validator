        ...
        private static readonly IList<IDguvNumberCheck> _checks = new List<IDguvNumberCheck>
            {
                ...
                new CharacterMapCheck("02379637", "Unfallkasse und Feuerwehrunfallkasse Brandenburg", -1, -1, string.Empty),
                ...
                new CharacterMapCheck("15087927", "Berufsgenossenschaft der Bauwirtschaft – Hamburg", -1, -1, string.Empty),
                ...
                new CharacterMapCheck("28143238", "Unfallversicherung Bund und Bahn – Bereich Bund (ehemals Unfallkasse des Bundes)", -1, -1, string.Empty),
                ...
                new CharacterMapCheck("29036720", "Berufsgenossenschaft der Bauwirtschaft – Hannover", -1, -1, string.Empty),
                ...
                new CharacterMapCheck("42884688", "Berufsgenossenschaft der Bauwirtschaft – Wuppertal", -1, -1, string.Empty),
                new CharacterMapCheck("44861264", "Unfallkasse Hessen", 10, 13, "0123456789/."),
                new CharacterMapCheck("44888436", "Berufsgenossenschaft der Bauwirtschaft – Frankfurt", -1, -1, string.Empty),
                ...
                new CharacterMapCheck("62279404", "Berufsgenossenschaft der Bauwirtschaft – Karlsruhe", -1, -1, string.Empty),
                ...
                new CharacterMapCheck("67350937", "Berufsgenossenschaft der Bauwirtschaft – Böblingen", -1, -1, string.Empty),
                ...
                new CharacterMapCheck("87661138", "Berufsgenossenschaft der Bauwirtschaft – München Hochbau", -1, -1, string.Empty),
                new CharacterMapCheck("87661183", "Berufsgenossenschaft der Bauwirtschaft – München Tiefbau", -1, -1, string.Empty),
